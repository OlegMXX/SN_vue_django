    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
                <div class="main-left col-span-1">
                    <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
                        ...
                        <div class="mt-6">
                            <button 
                                class="inline-block py-4 px-3 bg-purple-600 text-white text-xs rounded-lg" 
                            ...
                            <button 
                                class="inline-block mt-2 py-4 px-3 bg-purple-600 text-white text-xs rounded-lg" 
                        ...
                        <form v-on:submit.prevent="submitForm" method="post">
                            <div class="p-4">  
                                ...
                                <div id="preview" v-if="url">
                                    <img :src="url" class="w-[100px] rounded-xl mt-3"/>
                                </div>
                            </div>
    ...
    methods: {
        ...
        sendDirectMessage(){
            ...
            axios
                ...
                .catch(error => {
                    console.log('error in send_dm', error)
                })
        },
